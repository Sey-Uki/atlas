      ...
      <div className="content">
        ...
        {showCardLiver && (
          <div className="card">
            <div className="cards">
              <p>
                Печень - очень важный орган. Она выводит из организма вредные
                вещества, которые попадают в нее с пище. А еще в печени
                образуется желчь, благодаря этой жидкости организм лучше
                усваивает еду.
              </p>
        ...
        {showCardStomach && (
          <div className="card">
            <div className="cards">
              <p>
                Наш желудок похож на большую кастрюлю. В нем вся съединая пища
                смещивается с желудочным соком и получается полужидкая кашеца.
              </p>
              <img src={stomach} alt="" height="200" />
            </div>
          </div>
        )}
        {showCardGullet && (
          <div className="card">
            <div className="cards">
              <p>
                Как только еда оказывается у нас во рту, она отправляется в
                долгое путеществие по организму. Сначала зубы измельчают пищу, а
                потом через пищевод она попадает в желудок.
              </p>
              <img src={gullet} alt="" height="200" />
            </div>
          </div>
        )}
        {showCardIntestines && (
          <div className="card">
            <div className="cards">
              <p>
                Из желудка пища попадает в кашечник. Он всасывает все полезное,
                что ему необходимо.
              </p>
              <img src={intestines} alt="" height="200" />
            </div>
          </div>
        )}
      </div>
